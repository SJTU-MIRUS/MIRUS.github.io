...
<div style="border-left: 5px solid #cc0000; padding-left: 12px; margin-bottom: 25px;">
  <h2 style="margin: 0; font-size: 22px;">Principle Investigator</h2>
</div>
<hr style="height: 1px; border: none; background-color: #ddd; margin-bottom: 30px;" /> 

<div style="display: flex; flex-wrap: wrap; gap: 25px; margin-bottom: 60px; align-items: flex-start;">
...
<div style="border-left: 5px solid #cc0000; padding-left: 12px; margin-bottom: 25px;">
  <h2 style="margin: 0; font-size: 22px;">Students</h2>
</div>
<hr style="height: 1px; border: none; background-color: #ddd; margin-bottom: 30px;" /> 

<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 20px; margin-bottom: 40px;">

  <div style="display: flex; gap: 15px; padding: 20px; background-color: #f9f9f9; border-radius: 10px; border: 1px solid #eee; transition: transform 0.2s ease;">
    ...
    <div style="flex: 1; font-size: 14.5px; line-height: 1.5; word-break: break-word; text-align: justify;">
      ...
      <p style="margin: 3px 0;"><strong>Email:</strong> </p>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 15px; padding: 20px; background-color: #f9f9f9; border-radius: 10px; border: 1px solid #eee; transition: transform 0.2s ease;">
    ...
    <div style="flex: 1; font-size: 14.5px; line-height: 1.5; word-break: break-word; text-align: justify;">
      ...
      <p style="margin: 3px 0;"><strong>Email:</strong> chenpanzhao@sjtu.edu.cn</p>
    </div>
  </div>
